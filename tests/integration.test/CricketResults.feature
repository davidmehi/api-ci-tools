Feature: As a Cricket API consumer, I want to get India rankings in all formats
so that I can build a page
	...
	#This test can be run against the mock and the real backend
	Scenario: The Cricket API should show that India's T20 ranking was 5
		Given I set query parameters to
		| 	parameter   | 	value 		|
		|	team		|	India		|
		|	formatType 	|	T20			|
		When I GET /rankings
		Then response code should be 200
		Then response body path $.query.results.Team.Ranking should be 5
